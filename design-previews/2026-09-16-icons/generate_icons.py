...
def icon_panel():
    ...
    ov = layer()
    d = ImageDraw.Draw(ov)
    d.rounded_rectangle([224, 320, 480, 704], radius=40, fill=(255, 251, 244, 74))
    bar(d, 268, 424, 428, 26, (255, 251, 244, 215))
    bar(d, 268, 504, 404, 26, (255, 251, 244, 215))
    bar(d, 268, 584, 356, 26, (255, 251, 244, 215))
    img = Image.alpha_composite(img, ov)
    ov = layer()
    d = ImageDraw.Draw(ov)
