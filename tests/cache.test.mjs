...
const items = [{ id: "1", translation: "一个<strong>智能体</strong>评估模型。", terms: [{ source: "agent", target: "智能体" }] }];

test("stores and restores rich paragraph translations by URL and content", () => {
...
test("invalidates cache when paragraph content, markup, or model changes", () => {
